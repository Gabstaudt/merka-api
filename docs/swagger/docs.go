...
const docTemplate = `{
        ...
        "/configuracoes/{chave}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Chave da configuração (ex: taxa_servico, rodizio_por_pessoa)",
                        "name": "chave",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Configuração e se está ativa",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.salvarConfiguracaoRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.mesaRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/internal_handler.mesaCompletaResponse"
                        }
                    },
                    "400": {
                    ...
                    "409": {
                        "description": "já existe uma mesa com esse identificador",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/mesas/{id}": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Novo identificador",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/pagamentos/{id}/enviar-nota": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Canal (email|whatsapp) e destino",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.enviarNotaRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "canal inválido, destino obrigatório, ou nota não emitida",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "501": {
                        "description": "canal whatsapp ainda não implementado",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
    ...
    "definitions": {
        ...
        "internal_handler.enviarNotaRequest": {
            "type": "object",
            "properties": {
                "canal": {
                    "type": "string"
        ...
        "internal_handler.mesaCompletaResponse": {
            "type": "object",
            "properties": {
                "ativo": {
                    "type": "boolean"
        ...
        "internal_handler.salvarConfiguracaoRequest": {
            "type": "object",
            "properties": {
                "ativo": {
                    "type": "boolean"
